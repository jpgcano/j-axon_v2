...
export class PrismaAssetRepository implements AssetRepository {
  ...
  private generateIntegrityHash(id: string, description: string, date: Date): string {
  ...
  public async findById(id: string): Promise<Asset | null> {
    ...
    return new Asset({
      ...
      status: data.status as unknown as AssetStatus,
  ...
  public async findAll(): Promise<Asset[]> {
    ...
    return rows.map((data: any) => new Asset({
      id: data.id,
      description: data.description,
      category: data.category,
      status: data.status as unknown as AssetStatus,
  ...
  public async findByAssignedUser(userId: string): Promise<Asset[]> {
    const rows = await this.prisma.jaxonAsset.findMany({
  ...
  public async findIntegrityHash(id: string): Promise<string | null> {
