...
describe('AssetController Integration', () => {
  ...
  let createAssetMock: any;
  let listAssetsMock: any;
  let getAssetMock: any;
  let updateAssetMock: any;
  let assignAssetMock: any;
  let updateAssetStatusMock: any;
  let unassignAssetMock: any;
  ...
  describe('create', () => {
    ...
    it('should validate schema and pass actorId', async () => {
      ...
      expect(createAssetMock.execute).toHaveBeenCalledWith(
  ...
  describe('getById', () => {
    it('should return 200 and asset data', async () => {
      ...
      const req = { params: { id: 'asset-1' } } as any;
      const res = {
        status: vi.fn().mockReturnThis(),
        json: vi.fn(),
      } as any;
