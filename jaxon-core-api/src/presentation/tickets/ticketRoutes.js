...
const ticketController = new TicketController(createTicket, listTickets, getTicket, updateTicketStatus, closeTicket, assignTicket);
const ticketActionsController = new TicketActionsController(new ApplyAiSuggestionService(ticketRepository, auditLogger));
