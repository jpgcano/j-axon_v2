...
describe('Ticket Domain Entity', () => {
    ...
    describe('Constructor Validation', () => {
        it('should create a ticket with valid parameters', () => {
            const ticket = new Ticket(ticketId, assetId, 'Critical database failure', 4, 5, userId);
    ...
    describe('Serialization to Primitives', () => {
        ...
        it('should reconstruct from primitives', () => {
            ...
            expect(reconstructed.getRiskLevel().getValue()).toBe(ticket.getRiskLevel().getValue());
        });
    });
...
//# sourceMappingURL=Ticket.spec.js.map